...
- Background Ken Burns: `.zoom` layer scales 1.21 → 1.0 over 26s, alternating
  (52s round trip, ~7 px/s drift, ~11 px/s at mid-sweep). Ambient, never attention-seeking; the scrim sits above it
